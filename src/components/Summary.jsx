...
export default function Summary() {
    ...
    console.log(movie)
    return (
        <div className=' text-white  flex bg-[#0b1020] h-3/4'>
            ...
            <div className='flex-row'>
                ...
                <div className='flex'>
                    <button className='p-4  bg-blue-950 hover:bg-sky-300 hover:text-black rounded-lg m-2 '><a href={movie.officialSite}>Visit Official Page</a></button>
                    <Link className=' p-4 bg-blue-950 hover:bg-sky-300 hover:text-black rounded-lg m-2 ' to="/booking">Book This Movie/Series</Link>
                </div>
            </div>
        </div>
    )

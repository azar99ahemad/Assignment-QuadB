...
export default function Booking() {
  ...
  console.log(movie)
  return (
    <div className=' text-white  flex bg-[#0b1020] justify-center align-item-center'>
      ...
      <div className='flex-row'>
        ...
        <div className='flex'>
          <button className='p-4 bg-blue-950 hover:bg-sky-300 hover:text-black rounded-lg mx-5 '><a href="">Press to Book</a></button>
        </div>
